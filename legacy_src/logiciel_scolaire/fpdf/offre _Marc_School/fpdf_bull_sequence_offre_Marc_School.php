...
//---------------------------creation du repertoire dans le disque F****-------------------------------
$dossier_source2='F:/'; //c'est dans ce repertoire qui contiendra l'acte à insérer.
...
$note=mysql_fetch_array(mysqli_query($mysqli, "select *from note where id_sequence=$id_sequence and id_eleve=$id_eleve"));
...
$nombre_moyenne_matiere=mysqli_num_rows(mysqli_query("select *from note where id_sequence=$id_sequence and id_classe=$id_vrai_classe and $matiere>=10"));
...
$req_chaque_eleve=mysqli_query($mysqli, "select *from eleve where id_classe=$id_vrai_classe and visible_eleve!='non'");
 $k=0;
  ...
  {   
  $note_chaque_eleve=mysqli_fetch_array(mysqli_query($mysqli, "select *from note where id_sequence=$id_sequence and id_classe=$id_vrai_classe and id_eleve='".$t111_chaque_eleve['id_eleve']."'")); 
