...
////////////-------------------------------------------------------------------------------------------------------------------------------
$pdf->Image(''.$logo_etablissement.'', $x=140, $y=5,30,30); //Image('$nom', $bordure gauche, $bordurehaut,largeur,hauteur)
$pdf->Ln(10);
$pdf->Cell($bordure_nom_e_paysage);
...
$pdf->Cell(0,10,"TITULAIRE : " .utf8_decode(sexe($titulaire['sex_personnel']).$titulaire['nom_personnel']." ".$titulaire['prenom_personnel']),'C');
...
$pdf->Cell(0,9,utf8_decode('Tranches horaires'),'1','C');
//------------------------------------------------------------------------
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(70);
...
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,9,'Mardi','1','C');
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(140);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,9,'Mercredi','1','C');
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(170);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,9,'Jeudi','1','C');
...
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,9,'Samedi','1','C');

//--------fin de l'affichage de l'entete du table----------------------------------------------------------------
//-------------------------------SELECTION DE L4EMPLOI DE TEMPS DE LA CLASSE SELECTIONNE
	 $a=mysqli_query($mysqli, "select *from emploi_temps where id_classe=$id_classe order by numero_horaire asc");

//-----------------------------------debut de l'affichage de l'emploi de temps------------------------------
//------------------------------------------------------------------------
//-----------------------------------------------------------------------------
while ($temps=mysqli_fetch_array($a) )
{
	$pdf->Ln(9);
$pdf->Cell(10);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','B',12);
$pdf->Cell(0,9,utf8_decode($temps['heure']),'1','C');
//--------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(70);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['lundi']),'1','C');
//------------------------------------------------------------------------
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(110);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['mardi']),'1','C');
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(140);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['mercredi']),'1','C');
//-----------------------------------------------------------------------------
$pdf->Ln(0);
$pdf->Cell(170);
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['jeudi']),'1','C');
...
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['vendredi']),'1','C');
...
$pdf->SetTextColor(0,0,0);
$pdf->SetFont('Times','I',9);
$pdf->Cell(0,9,utf8_decode($temps['samedi']),'1','C');
}
...
$dossier_source2='F:/'; //c'est dans ce repertoire qui contiendra l'acte à insérer.
	...
	if (!is_dir($dossier_source2)){
			mkdir($dossier_source2);}
//----------------------------------fin de creation du repertoire de l'eleve-----------------------------------------------------------------------------
	$dossier_source.="Emploi_de_temps";
	$dossier_source.=$date_jour;
	 $dossier_source.=".pdf";
	 
	 $dossier_source2.="Emploi_de_temps";
