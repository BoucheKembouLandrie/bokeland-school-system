...
$nom_etablissement=majuscule($eta['nom_etablissement']);
	 ...
	 $id_vrai_classe=$cla_el['id_classe'];
	  ...
	  $nom_eleve=utf8_decode( majuscule($nom));
...
$pdf->Image($histogramme, $x=10, $y=$hauteur,58,40); //Image('$nom', $bordure gauche, $bordurehaut,largeur,hauteur)
