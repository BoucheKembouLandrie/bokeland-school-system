...
exports.initiateClientPayment = exports.extendSubscription = exports.activateTrial = exports.checkLicense = void 0;
...
const checkLicense = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        let client = yield Client_1.Client.findOne({ where: { machine_id } });
        if (!client) {
            ...
            if (school_name && email) {
                ...
                if (affiliate_email) {
                    ...
                    if (normalizedAffiliateEmail !== email.trim().toLowerCase()) { // Prevent self-referral
                        let affiliate = yield Affiliate_1.Affiliate.findOne({ where: { email: normalizedAffiliateEmail } });
                        if (!affiliate) {
                            affiliate = yield Affiliate_1.Affiliate.create({
                ...
                try {
                    client = yield Client_1.Client.create({
                        machine_id,
                        school_name,
                        email,
                        phone: phone || null,
                    ...
                    if (createErr.name === 'SequelizeUniqueConstraintError') {
                        client = yield Client_1.Client.findOne({ where: { machine_id } });
                        if (!client)
                            throw createErr;
                ...
                const config = yield Config_1.Config.findByPk('annual_subscription_rate');
...
const activateTrial = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { machine_id, school_name, email, phone, address, city, country, affiliate_email } = req.body;
...
const initiateClientPayment = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.initiateClientPayment = initiateClientPayment;
