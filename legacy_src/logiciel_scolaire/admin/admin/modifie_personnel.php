...
<body>
       ...
       <?php include "php/menu_admin.php"; ?>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><h2><?php echo @$page_admin //variable comportant le nom de la section ?> /Modification du personnel </h2>   </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
                ...
                <hr />                
                 <!-- /. ROW  -->
                  <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <?php include "formulaire_modifie_personnel.php"; ?> 
                     </div>
                    </div>
                </div>
  ...
  <div class="panel panel-primary text-center no-boder bg-color-green">
                        <div class="panel-body">
                            ...
                            <h4>Commentaire</h4>
                           Dans cette rubrique, vous avez la possibilité de changer le nom, prenom, contact, email et la photo du personnel.      
                        </div>
