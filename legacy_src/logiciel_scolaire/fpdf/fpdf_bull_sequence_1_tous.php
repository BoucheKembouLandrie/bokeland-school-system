...
$dossier_source3='C:/'; //c'est dans ce repertoire qui contiendra l'acte à insérer.
	$dossier_source3= sous_repertoire($dossier_source3, "Bulletins Seq ".$id_sequence); // lien du premier sous repertoire
...
if($verification==1) {echo '<script language="javascript"> alert("Les bulletins ont bien été générés. Ils se trouvent dans votre disque '.$disque.' dans le repertoire: Bulletins Seq '.$id_sequence.'/'.$classe.'");</script>';}
