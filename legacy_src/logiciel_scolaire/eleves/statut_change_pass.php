...
<body>
       ...
       <?php include "php/menu_eleves.php"; ?>    
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><h2><?php echo $eleves;//variable comportant le nom de la section ?> /Modification du profil </h2>   </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
  ...
  <div class="panel panel-primary text-center no-boder bg-color-green">
                    ...
                    <?php include "formulaire_verifi_profil_pass.php"; ?> 
					...
					{ $mdp=$_POST['mdp'];
						$id_eleve=$_POST['id_eleve'];
 	  					...
 	  					$rech=mysqli_num_rows(mysqli_query($mysqli, "select * from eleve where id_eleve=$id_eleve and pass_eleve='$mdp'"));
