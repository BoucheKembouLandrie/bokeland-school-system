...
if (affiche_eleve!==""){
	$('#loader').show();//on affiche le chargement quand l'utilisateur tape sur le clavier
	$.post('service_prefecture/post_trimestre_1.php',{id_classe:affiche_eleve, numero_trimestre:numero_trimestre},function(data){
...
<div class="row">
       ...
       <!-- barre  -->
                ...
                <div class="row" >
                    ...
                    <h4 style="color:#03F">Notes trimestre N°1</h4>
