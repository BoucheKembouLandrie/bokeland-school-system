...
<body>
       ...
       <?php include "php/menu_prefecture.php"; ?>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><h2><?php echo @$prefecture //variable comportant le nom de la section ?> / Message de notification </h2>   </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
       ...
       <!-- barre  -->
                <hr />                
                 <!-- /. ROW  -->
                    ...
                    <?php include "formulaire_notification.php"; ?> 
  ...
  <div class="panel panel-primary text-center no-boder bg-color-green">
                        <div class="panel-body">
                            ...
                            <h4>Commentaire</h4>
                           Ce formulaire permet au chef d'etude d'envoyer les messages de notifications aux parents des eleves et au personnel de l'etablissement
