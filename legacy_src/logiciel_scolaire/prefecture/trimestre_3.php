...
if (affiche_eleve!==""){
	$('#loader').show();//on affiche le chargement quand l'utilisateur tape sur le clavier
	$.post('service_prefecture/post_trimestre_3.php',{id_classe:affiche_eleve, numero_trimestre:numero_trimestre},function(data){
...
<div class="row">
       ...
       <!-- barre  -->
                ...
                <div class="row" >
                    ...
                    <div id="loader"><h4 style="color:#03F; font-size:12px;"><img src="images/loading-bar.gif" height="20"/>  Veillez patienter pendant que Docarn School génère les bulletins...</h4> </div>
 
                    
                    <div class="col-md-12 col-sm-12 col-xs-12">
               
                    <div class="panel panel-default">
                    <h4 style="color:#03F">Notes trimestre N°3</h4>
