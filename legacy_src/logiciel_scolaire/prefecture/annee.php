...
<link rel="stylesheet" href="inscriptioneleve_files/formoid1/formoid-solid-blue.css" type="text/css" />
	...
	$.post('../fpdf/fpdf_bull_annuelle_tous.php',{generer_bull_tous_eleve:a, id_sequence_generer:b},function(data){
		//$('#profil').hide();
...
if (affiche_eleve!==""){
	$('#loader').show();//on affiche le chargement quand l'utilisateur tape sur le clavier
	$.post('service_prefecture/post_annee.php',{id_classe:affiche_eleve, numero_sequence:numero_annee},function(data){
       ...
       <?php include "php/menu_prefecture.php"; ?>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><?php echo $prefecture; //variable comportant le nom de la section ?> / Generation des releves de notes annuelle</h2>   
...
<div class="row">
       ...
       <!-- barre  -->
                ...
                <div class="row" >
                    ...
                    <div id="loader"><h4 style="color:#03F; font-size:12px;"><img src="images/loading-bar.gif" height="20"/>  Veillez patienter pendant que Marc School génère les bulletins...</h4> </div>
 
                    
                    <div class="col-md-12 col-sm-12 col-xs-12">
               
                    <div class="panel panel-default">
                    <h4 style="color:#03F">Liste de bulletins annulles</h4>
		 ...
		 $nom_mat=mysqli_fetch_array( mysqli_query($mysqli, "select *from matiere where id_matiere=$v and id_classe=$id_classe"));
	 		...
	 		{ //---------------------------------------------------------------------------------
				...
				{ //si ($nombre_note!==0) on fait un update
					if (mysqli_query($mysqli, "update note set  id_eleve='".$tab_ID_ele[$in]."', id_sequence='".$numero_sequence."', id_trimestre='".$numero_trimestre."', date_enre_note='".time()."', $nom_matiere='".$tab_note_mat[$in][$c]."' where  id_eleve='".$tab_ID_ele[$in]."' and id_sequence='".$numero_sequence."' and  id_trimestre='".$numero_trimestre."' "))
		 		{$verification=1;}
		 		else
		 		{$verification=0;} 
				}
