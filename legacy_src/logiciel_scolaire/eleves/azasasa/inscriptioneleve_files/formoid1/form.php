...
<form class="formoid-metro-cyan" style="background-color:#ffffff;font-size:25px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#550000;max-width:900px;min-width:150px" method="post"><div class="title"><h2>My form</h2></div>
