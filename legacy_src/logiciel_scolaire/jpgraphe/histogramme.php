...
for($i=1; $i<=6; $i++){
	$tableauAnnees[] = 'Séq ' . $i;
	if($i%2==0) $tableauNombreVentes[] = $i*5;
	else $tableauNombreVentes[] = $i+2;
}
...
// Le titre
$graph->title->Set("Histogramme des notes de AZEMKOUO Cedric");
$graph->title->SetFont(FF_FONT1,FS_BOLD);

// Titre pour l'axe horizontal(axe x) et vertical (axe y)
$graph->xaxis->title->Set("Sequence");
$graph->yaxis->title->Set("Note /20");
...
$graph->Stroke('pdf/merci seigneur04.jpg');
$graph->Stroke();
