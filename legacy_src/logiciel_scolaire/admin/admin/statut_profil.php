...
<body>
       ...
       <?php include "php/menu_admin.php"; ?>  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><?php echo @$page_admin //variable comportant le nom de la section ?> / Profil  </h2>   
  ...
  <div class="panel panel-primary text-center no-boder bg-color-green">
                        <div class="panel-body">
                            ...
                            <h4>Commentaire </h4>
                Dans cette partie, vous pouvez changez votre profil administrateur (Login et mot de passe).
                        </div>
