...
<link rel="stylesheet" href="inscriptioneleve_files/formoid1/formoid-solid-blue.css" type="text/css" />
	...
	$.post('../fpdf/fpdf_bull_trimestre_tous.php',{generer_bull_tous_eleve:a, id_sequence_generer:b},function(data){
		//$('#profil').hide();
...
if (affiche_eleve!==""){
	$('#loader').show();//on affiche le chargement quand l'utilisateur tape sur le clavier
	$.post('service_prefecture/post_trimestre_2.php',{id_classe:affiche_eleve, numero_trimestre:numero_trimestre},function(data){
...
<div class="row">
       ...
       <!-- barre  -->
                ...
                <div class="row" >
                    ...
                    <h4 style="color:#03F">Notes trimestre N°2</h4>
