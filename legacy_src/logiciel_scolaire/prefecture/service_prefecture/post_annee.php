...
if(isset($_POST['id_classe']) and isset($_POST['numero_sequence']) )
{		
		$numero_sequence=$_POST['numero_sequence'];//$numero_sequence=1;
	 $id=$_POST['id_classe'];
...
<?php //--------------------------------------------------------pour chaque matier, on creera un input text pour la note-------------------------- ?>                                           
									...
									<?php echo'
                                        <td><a href="../fpdf/fpdf_bull_annuelle.php?id_sequence='.$numero_sequence.'&id_eleve='.$tt['id_eleve'].'" target="_blank">Générer le bulettin Annuelle</a></td>
										</tr>
										';
                                       } 
                                    echo '</tbody> </table>
