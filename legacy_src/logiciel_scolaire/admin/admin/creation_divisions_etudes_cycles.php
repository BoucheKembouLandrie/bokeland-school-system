...
<head>
    <title>GESTION SCOLARITE</title>
     ...
     <?php 
$s=mysqli_query($mysqli, "select *from cycle order by nom_cycle asc");
?>
</head>
...
<body>
    <div id="wrapper">
       ...
       <!-- barre  -->
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    ...
                    <?php include "formulaire_creation_divisions_etudes_cycles.php"; ?> 
                   		 </div>
                    </div>
  ...
  <div class="panel panel-primary text-center no-boder bg-color-green">
                        <div class="panel-body">
                            ...
                            <h4>Commentaire</h4>
                            Grace à ce formulaire, vous pouvez créer des cycles pour votre établissement.</br><h4>Liste des cycles</h4>
                            <?php while($t=mysqli_fetch_array($s)){ ?>
		<li><?php echo $t['nom_cycle']; ?></li>
		<?php } ?>
