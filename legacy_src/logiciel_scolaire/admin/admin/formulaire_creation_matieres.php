...
<div class="title"><h2 style="color:#03C;">Création des matières</h2></div>
    ...
    <input class="large" type="text" name="nom" value="<?php if(isset($_POST['nom'])) {echo $_POST['nom'];}?>" required placeholder="Exemple: MATHEMATIQUES"/></div>
    ...
    <?php $o=0; while($tab_td1=mysqli_fetch_array($td1)){ $o++; ?> 
    	<li>
           <input type="checkbox" name="classe[]" value="<?php echo $tab_td1['id_classe'];  ?>"  / ><span><?php echo ' '.$tab_td1['nom_unique_classe'].'  ';  ?> 
        </li>
         <?php }  ?> 
         </ul>
         </div>
