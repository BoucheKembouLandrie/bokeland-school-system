...
$pdf->Cell(65,7,utf8_decode("BULLETIN TRIMESTRIEL N° ".$id_sequence.""),'1','C');
//------------------------------------------------------------------------------------------------------------------------------------
$pdf->Ln(7);$hauteur=$hauteur+7;
...
$pdf->Cell(58);
$pdf->SetFont('Times','B',9);
$pdf->Cell(0,7,utf8_decode("seq 2"),'1','C');
$pdf->Ln(0);
$pdf->Cell(72);
$pdf->SetFont('Times','I',6);
$pdf->Cell(0,3,utf8_decode("Avg/20"),'C');
...
$dossier_source3='C:/'; //c'est dans ce repertoire qui contiendra l'acte à insérer.
	$dossier_source3= sous_repertoire($dossier_source3, "Bulletins trim".$id_sequence); // lien du premier sous repertoire
...
if($verification==1) {echo '<script language="javascript"> alert("Les bulletins ont bien été générés. Ils se trouvent dans votre disque '.$disque.'  dans le repertoire: Bulletins trim'.$id_sequence.'/'.$classe.'");</script>';}
