...
<head>
    <title>GESTION DES ETUTDES</title>
      <?php include "php/head_surveillants.php"; ?>
      <?php  
...
<body>
    <div id="wrapper">
       <?php include "php/menu_surveillants.php"; ?>  
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2><?php echo $surveillance; //variable comportant le nom de la section ?> /Emploi de temps </h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
